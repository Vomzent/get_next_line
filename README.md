...
# Instructions
When using this function you must compile it with `--define BUFFER_SIZE=` followed by a value.<br>
...
Compiling without defining a `BUFFER_SIZE` yourself will default to `BUFFER_SIZE=500`<br>
